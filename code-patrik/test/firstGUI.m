...
% Last Modified by GUIDE v2.5 12-Apr-2011 20:20:54
...
% so window can get raised using firstGUI.
...
set(hObject, 'String', {'plot(rand(5))', 'plot(sin(1:0.01:25))', 'bar(1:.5:10)', 'plot(membrane)', 'surf(peaks)','test'});
